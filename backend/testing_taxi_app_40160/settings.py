"""
Django settings for testing_taxi_app_40160 project.
...
ROOT_URLCONF = 'testing_taxi_app_40160.urls'
...
WSGI_APPLICATION = 'testing_taxi_app_40160.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testing_taxi_app_40160 API",
    "DESCRIPTION": "API documentation for testing_taxi_app_40160 App",
    "VERSION": "v1",
}
